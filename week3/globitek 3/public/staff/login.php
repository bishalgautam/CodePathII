  ...
  if (empty($errors)) {
    ...
    if($user) {
      if($password === $master_password) {
        ...
        $errors[] = "Username and Password do not match."; // TODO write an error message
      }
    } else {
      // No username found
      $errors[] = "None registered users found by the username ". $username . "."; // TODO write an error message
    }
  }
}
